...
class Files:
    """
    Classe de criacao dos arquivos json com base nos XML
    """
    ...
    def __createJson(self, file:str):
        ...
        try:
            ...
            self.invalidXML["{0}".format(file)]="XML inválido"

class Validator:
    """
    Classe de Validacao dos Jsons utilizando um JsonSchema
    """
...
if __name__ == "__main__":
    ...
    for k in teste2.invalidJson:
        print("invalido ", k)
        print("motivo ", teste2.invalidJson[k], "\n")